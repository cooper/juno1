...
#                                                                   #
#####################################################################
#              local server package - juno ircd                     #
#####################################################################
...
sub loadconffile {
 ...
 CONFPARSE: foreach $line (@lines) {
    ...
    my $lr = "\033[1;31m";
    my $lb = "\033[1;36m";
    Utils::plog("lred","warning","Line ".$i.' in '.$this->{'conffile'}." invalid.");
    opernotify($this,"Line $i in configuration is invalid.");
